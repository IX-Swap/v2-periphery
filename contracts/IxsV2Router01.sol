...
contract IxsV2Router01 is IIxsV2Router01 {
    ...
    function swapExactTokensForTokens(
        ...
        TransferHelper.safeTransferFrom(path[0], msg.sender, IxsV2Library.pairFor(factory, path[0], path[1]), amounts[0]);
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) public pure override returns (uint amountIn) {
        return IxsV2Library.getAmountOut(amountOut, reserveIn, reserveOut);
    }
