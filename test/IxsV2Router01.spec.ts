...
enum RouterVersion {
  IxsV2Router01 = 'IxsV2Router01',
  IxsV2Router02 = 'IxsV2Router02'
}

describe('IxsV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.IxsV2Router01]: fixture.router01,
        [RouterVersion.IxsV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.IxsV2Router01]: 101876,
              [RouterVersion.IxsV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.IxsV2Router01]: 138770,
              [RouterVersion.IxsV2Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
